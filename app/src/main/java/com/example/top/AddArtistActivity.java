...
//        mArtista.setNotas(etNotas.getText().toString().trim());
    ...
    private boolean validatesFields() {
        ...
        if(etEstatura.getText().toString().trim().isEmpty() ||
                Integer.valueOf(etEstatura.getText().toString().trim()) <getResources().getInteger(R.integer.altura_min)){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.label_dialog_add, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        configImagerView(etFotoUrl.getText().toString().trim());
                    }
                })
    ...
    private void configImagerView(String fotoUrl){
        if (fotoUrl != null){
